            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="justify-between items-center gap-12 md:flex">
                    <div className="flex-1 max-w-lg">
                        ...
                        <span className="text-gray-500 text-[12px] sm:text-sm sm:ml-[130px]">Click here to join us. T & C Applied.
                            </span>
                ...
                <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
                    <p className="text-gray-600 text-center">© 2024 Prashna Pedia. All Rights Reserved</p>
                    <div className="flex items-center gap-x-6 sm:ml-0 ml-[90px] text-gray-400 mt-6">
